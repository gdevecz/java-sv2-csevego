...
public class GuessTheNumberIO {
    ...
    //    NA KITESZTELTEM, ha új Scanner páldány van, a sc1 után sc2 akkor:
    //    sc1.nextInt(); után az sc2 már a sortörés után kezdett, vagyis jó, ha a metódusban példányosítok

    //ez akkor nem kell, így a kobstructor as maradhat az auto
    //private Scanner sc;
